...
\begin{document}
	...
	\begin{flushleft}
		...
		\rule[5pt]{\textwidth}{0.4pt}
		\textbf{Proficient in} Python, C\#, SQL, VBA, Bash, \LaTeX Bash; Git, GitLab CI/CD\\
		\textbf{Familiar with} C/C++, MATLAB, JavaScript; Linux \\
		\textbf{Exploring} HTML, CSS; Docker, Linux, Heroku
	\end{flushleft}
